...
namespace DesafioViajaNet.Entity.Migrations
{
    ...
    [Migration("20190626015645_CriacaoTableConfirmacaoPedidoComportamento")]
    partial class CriacaoTableConfirmacaoPedidoComportamento
    {
            ...
            modelBuilder.Entity("DesafioViajaNet.Dominio.CheckoutPedidoComportamento", b =>
                {
                    ...
                    b.Property<long>("VooCodigo");

                    b.HasKey("Codigo");

                    b.HasIndex("VooCodigo");
            ...
            modelBuilder.Entity("DesafioViajaNet.Dominio.Viagem", b =>
                {
                    ...
                    b.Property<long>("DestinoCodigo");

                    b.Property<long>("OrigemCodigo");

                    b.HasKey("Codigo");

                    b.HasIndex("DestinoCodigo");

                    b.HasIndex("OrigemCodigo");
            ...
            modelBuilder.Entity("DesafioViajaNet.Dominio.Voo", b =>
                {
                    ...
                    b.Property<long>("ViagemCodigo");

                    b.HasKey("Codigo");

                    b.HasIndex("ViagemCodigo");
